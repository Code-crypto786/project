...
<html lang="en">
  <head>
    ...
    <title>tablets | right products</title>
     ...
     <ul class="nav sidebar-nav">
      ...
      <li><a href="tablets">tablets</a></li>
        ...
        <div id="page-content-wrapper">
            ...
            <h3 style="color:#1D2B36;">&nbsp;<i class="fa fa-list fa-1x" aria-hidden="true"></i> categories /<i class="fa  fa-tablet fa-1x" aria-hidden="true"></i> tablets</h3>
