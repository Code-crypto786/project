...
<html lang="en">
  <head>
    ...
    <title>power banks | right products</title>
     ...
     <ul class="nav sidebar-nav">
      ...
      <li><a href="tablets">tablets</a></li>
        ...
        <div id="page-content-wrapper">
            ...
            <h3 style="color:#1D2B36;">&nbsp;<i class="fa fa-list fa-1x" aria-hidden="true"></i> categories /<i class="fa  fa-battery-half fa-1x" aria-hidden="true"></i> PowerBanks</h3>
