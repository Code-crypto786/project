...
$totall = 0;
if(session()->has('user')){
  $totall = ProductController::CartItem();
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>myorders || right Products</title>
...
<nav class="navbar navbar-default nav-color">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                @if(Session::has('user'))
                     <li ><a class="color" href="cartlist">Cart&nbsp;<span class="badge"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;{{$totall}}</span></a><i class="fa fa-shopping-cart" aria-hidden="true"></i></li>
                        @endif
                        @if(Session::has('user'))
...
@foreach($order as $item)
   ...
   <div class="col-sm-2 col-xs-12">
    ...
    <div class="col-sm-2  col-xs-12">
      ...
      <small>status</small>
      <div style="padding-top:30px;">
      <b style="padding:5px;background-color:#EC971F;color:#fff;">{{$item->status}}</b>
      </div>
...
@endforeach
@if(!isset($item->id))
<h3 style="color:red;" class="text-center">Empty ! you did't orderd</h3>
@endif
</div>
   </div>
</div>
</section>
<footer class=" footer " style="padding:50px;margin-top:210px;">
<div class="row">
